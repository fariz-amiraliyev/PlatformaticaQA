...
public class EntityArithmeticInTest extends BaseTest {
    ...
    private final int sub = num1 - num2;
    private final int mul = num1*num2;
    private final int div = num1/num2;

    private final String F1 = "Hi";
    ...
    private void getNewRecord () {
        ...
        getWebDriverWait()
                .until(ExpectedConditions.textToBePresentInElementValue(By.xpath("//input[@id = 'div']"), "0.43"));
        ...
        private void setNewData () {
            ...
            WebElement error = driver.findElement(By.xpath("//body[contains(text(), 'error saving entity')]"));
